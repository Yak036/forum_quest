<nav x-data="{ open: false }" class="bg-gray-700 border-b border-gray-200">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-600 bg-white hover:text-yellow-600 focus:outline-none transition ease-in-out duration-150">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')" class="text-gray-700 hover:bg-yellow-50 hover:text-yellow-600">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')"
                                    ...
                                    class="text-gray-700 hover:bg-yellow-50 hover:text-yellow-600">
                                {{ __('Log Out') }}
                            </x-dropdown-link>
                        </form>
                    </x-slot>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('login')" class="text-gray-700 hover:bg-yellow-50 hover:text-yellow-600">
                            {{ __('Iniciar sesion') }}
                        </x-dropdown-link>

                        <x-dropdown-link :href="route('register')" class="text-gray-700 hover:bg-yellow-50 hover:text-yellow-600">
                            {{ __('Registrarse') }}
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-yellow-600 hover:bg-yellow-50 focus:outline-none focus:bg-yellow-50 focus:text-yellow-600 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">Tienes cuenta?</div>
                <div class="font-medium text-sm text-gray-500">Tienes cuenta?</div>
            </div>
