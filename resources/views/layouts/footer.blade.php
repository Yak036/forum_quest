      ...
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-8 xl:mt-0">
              ...
              <form class="mt-4 sm:flex sm:max-w-md">
                  <label for="email-address" class="sr-only">Dirección de correo</label>
                  ...
                  <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                      <button type="submit" class="w-full bg-yellow-600 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-yellow-500">
                          Suscribirse
                      </button>
                  </div>
              </form>
